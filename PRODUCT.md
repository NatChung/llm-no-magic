...
4. **One visual language across all 9 tabs** — a learner moves through ①→⑧ in one sitting, so typography, spacing, and component patterns must stay consistent tab to tab.
